...
function MakeNotifi(Configs)
  local Title = Configs.Title or "HLuuVN"
...
function MakeWindow(Configs)
  local title = Configs.Hub.Title or "HLuuVN"
  local Anim_Title = Configs.Hub.Animation or "by : @HLuuVN"
  
  local KeySystem = Configs.Key.KeySystem or false
  local KeyTitle = Configs.Key.Title or "Key"
  ...
  local KeyNotSuccess = Configs.Key.Notifi.Incorrectkey or "Key không chính xác"
  local KeySuccess = Configs.Key.Notifi.CorrectKey or "Chạy Script..."
  local KeyCopyKeyLink = Configs.Key.Notifi.CopyKeyLink or "Đã sao chép vào Clipboard"
  ...
  local function CreateClose()
    ...
    local Mensage = Create("TextLabel", CloseMenu, {
      ...
      Text = "Bạn có chắc chắn muốn đóng script không",
