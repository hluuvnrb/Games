loadstring(game:HttpGet(("https://raw.githubusercontent.com/hluuvnrb/Games/refs/heads/main/main.lua")))()

       local Window = MakeWindow({
         Hub = {
         Title = "📜All Script Roblox",
         Animation = "🇻🇳Việt Nam"
         },
        Key = {
        KeySystem = false,
       ...
       Incorrectkey = "⛔Key không chính xác",
       ...
       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=93553898989285",
       Size = {60, 60},
     ...
     local Tab0 = MakeTab({Name = "ServerVIP"})
     local Tab1 = MakeTab({Name = "Blox Fruit"})
     local Tab2 = MakeTab({Name = "99 Đêm"})
